...
def program_controller_noRob(ser, m, n):
    ser.write("pcx\r\n".encode())
    command = 'pcr 1000' + m + '0' + n + ' 3F8\r\n'
    print('sending command ' + command)
...
ser = serial.Serial(port='COM4', baudrate=115200, bytesize=serial.EIGHTBITS, stopbits=serial.STOPBITS_ONE, dsrdtr=False,
                  rtscts=False, xonxoff=False)

program_controller_noRob(ser, map_m[0], str(0))
